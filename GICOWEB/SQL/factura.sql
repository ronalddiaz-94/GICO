-- Table: public.facturacliente

-- DROP TABLE public.facturacliente;

CREATE TABLE public.factura
(
  facturaid integer NOT NULL,
  clientid integer NOT NULL,
  facturatotal numeric,
  facturatime numeric,
  facturastate numeric,
  facturadate date,
  facturaiva numeric,
  facturasubtotal numeric,
  CONSTRAINT facturaclient_pkey PRIMARY KEY (facturaid, clientid),
