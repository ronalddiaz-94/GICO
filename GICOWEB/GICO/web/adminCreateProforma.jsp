...
<html>
    ...
    <body>
        <script >
            var $unidad = " crear proforma";
            var $tituloheader = "Crear Proforma";
        </script>
        ...
        <main class="principalUserCP">
            ...
            <section class="principalUserCP_contenido">
                <%@include file="gicoProforma/cpMCreateProforma.jsp"%><%-- Ventanas modales gestion de productos --%>
                <%@include file="gicoProforma/cpDTCreateProforma.jsp"%><%-- Data table de gestion produtos --%>
            </section>
        </main>
        <%@include file="templates/footer.jsp"%>
        <script src="js/jspdf.min.js" type="text/javascript"></script>
        <script src="js/createProforma.js" type="text/javascript"></script>
