...
<html>
    ...
    <body>
        <script >
            var $unidad = "gestion de proveedores";
            var $tituloheader = "Proveedores";
        </script>
        ...
        <main class="principalUserCP">
            ...
            <section class="principalUserCP_contenido"> 
                <%@include file="gicoProvider/cpMProvider.jsp"%><%-- Ventanas modales gestion de proveedores --%>
                <%@include file="gicoProvider/cpDT.jsp"%><%-- Data table de gestion proveedores --%>
            </section>
        </main>
