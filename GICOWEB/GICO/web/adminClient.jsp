    ...
    <body>
        ...
        <main class="principalUserCP">
            ...
            <section class="principalUserCP_contenido"> 
                <%@include file="gicoClient/cpMClient.jsp"%><%-- Ventanas modales gestion de proveedores --%>
                <%@include file="gicoClient/cpDT.jsp"%><%-- Data table de gestion proveedores --%>
            </section>
        </main>
