...
<html>
    ...
    <body>
        <script >
            var $unidad = "gestion de tipos de usuarios";
            var $tituloheader = "Tipo Usuario";
        </script>
        ...
        <main class="principalUserCP">
            ...
            <section class="principalUserCP_contenido"> 
                <%@include file="gicoUserType/cpMUserType.jsp"%><%-- Ventanas modales gestion de proveedores --%>
                <%@include file="gicoUserType/cpDT.jsp"%><%-- Data table de gestion proveedores --%>
            </section>
        </main>
