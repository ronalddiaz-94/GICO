...
<html>
    ...
    <body>
        <script >
            var $unidad = "gestion de productos";
            var $tituloheader = "Productos";
        </script>
        ...
        <main class="principalUserCP">
            ...
            <section class="principalUserCP_contenido">
                <%@include file="gicoProduc/cpMProduc.jsp"%><%-- Ventanas modales gestion de productos --%>
                <%@include file="gicoProduc/cpDT.jsp"%><%-- Data table de gestion produtos --%>
            </section>
        </main>
        <%@include file="templates/footer.jsp"%>
        <script src="js/produt.js" type="text/javascript"></script>
