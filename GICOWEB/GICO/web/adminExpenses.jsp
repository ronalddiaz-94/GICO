...
<html>
    ...
    <body>
        <script >
            var $unidad = "gestion de gastos";
            var $tituloheader = "Gastos";
        </script>
        ...
        <main class="principalUserCP">
            ...
            <section class="principalUserCP_contenido">
                <%@include file="gicoExpenses/cpMExpenses.jsp"%><%-- Ventanas modales gestion de productos --%>
                <%@include file="gicoExpenses/cpDT.jsp"%><%-- Data table de gestion produtos --%>
            </section>
        </main>
